...
worksheet.write(2,1,"ArticleNumber")
worksheet.write(2,2,"All Count")
worksheet.write(2,3,"Nouns")
worksheet.write(2,4,"Compound-Stop-Word Remove")
worksheet.write(2,5,"Date")
...
#workbook.save('R_word-count-Date.xls')
