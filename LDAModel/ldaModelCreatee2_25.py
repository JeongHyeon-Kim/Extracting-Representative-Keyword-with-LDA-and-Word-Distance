...
dictionary_path = "/home/ice-kms/LDAModel/JJ_Real_articleDic_10000_compound_topicNum_25.dict"
...
ldamodel = gensim.models.ldamodel.LdaModel(corpus,num_topics=25,id2word = dictionary, passes = 200, iterations=2000)

#print(len(ldamodel))

print(ldamodel.show_topics(num_topics=20,num_words=5,formatted=False))

lda_model_path = "/home/ice-kms/LDAModel/JJ_Real_lda_10000_pass_200_topicNum_25.lda"
