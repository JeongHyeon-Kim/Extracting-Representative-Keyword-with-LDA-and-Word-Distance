...
worksheet = workbook.add_sheet('TopicNum_20_pass_200')
...
for row in rows:
	...
	lda_model_path = "/home/ice-kms/LDAModel/Real_lda_10000_pass_200_topicNum_20.lda"
	lda = LdaModel.load(lda_model_path)
	
	dictionary_path= "/home/ice-kms/LDAModel/Real_articleDic_10000_pass_200_compound_topicNum_20.dict"
	dictionary = corpora.Dictionary.load(dictionary_path)
...
workbook.save('TopicNum20_pass_200.xls')
