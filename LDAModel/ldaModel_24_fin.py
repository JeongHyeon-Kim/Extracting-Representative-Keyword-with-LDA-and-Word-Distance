...
ldamodel = gensim.models.ldamodel.LdaModel(corpus,num_topics=24,id2word = dictionary, passes = 200, iterations=2000)

#print(len(ldamodel))

print(ldamodel.show_topics(num_topics=24,num_words=5,formatted=False))
