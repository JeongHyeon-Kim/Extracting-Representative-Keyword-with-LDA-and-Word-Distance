...
cursor.execute("set names utf8")
sql = "select Content from Raw limit 100"
...
dictionary_path = "/home/ice-kms/LDAModel/articleDic_100_topicNum_20.dict"
...
ldamodel.show_topics(num_topics=20,num_words=5,formatted=False)

lda_model_path = "/home/ice-kms/LDAModel/lda_20_topic_100_topicNum_20.lda"
...
print (numpy.exp2(-perplex / sum(cnt for document in corpus for _, cnt in document)))
