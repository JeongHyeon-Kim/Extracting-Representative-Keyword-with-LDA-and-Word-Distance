...
#						print("재검색")
						...
						for locsen in senword:
							sql9="select Word, 0.9*10*(1/abs(Loc_in_sen-%s)) as value from (select * from WordDistance where Sentence=%s and Articlenumber=%s) as B where Loc_in_sen != %s ";
	...
	#					print(wordscore)
						...
						sql10="select Word, 0.1*10*(1/abs(Loc_in_sen-%s)) as value from (select * from WordDistance where Sentence=%s and Articlenumber=%s) as B where Loc_in_sen !=%s";
