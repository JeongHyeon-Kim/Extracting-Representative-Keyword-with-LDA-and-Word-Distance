...
cursor.execute("set names utf8")
sql = "select ArticleTitle from RawDB limit 10000"
...
dictionary_path = "/home/ice-kms/LDAModel/articleTitleDic_10000.dict"
...
#lda 모델 형성
#ldamodel = gensim.models.LdaMallet(mallet_path, corpus, num_topics=20, id2word=dictionary, workers=4, prefix=None, optimize_interval=0, iterations=20)
...
lda_model_path = "/home/ice-kms/LDAModel/ldaTitle_20_topic_10000.lda"
