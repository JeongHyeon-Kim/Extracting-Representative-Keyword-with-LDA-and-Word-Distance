...
worksheet = workbook.add_sheet('TopicNum_20_iter_500')
...
for row in rows:
	...
	lda_model_path = "/home/ice-kms/LDAModel/iter_500_Real_lda_10000_pass_100_topicNum_20.lda"
	lda = LdaModel.load(lda_model_path)
	
	dictionary_path= "/home/ice-kms/LDAModel/iter_500_Real_articleDic_10000_compound_topicNum_20.dict"
	dictionary = corpora.Dictionary.load(dictionary_path)
...
workbook.save('TopicNum20_iter_500.xls')
