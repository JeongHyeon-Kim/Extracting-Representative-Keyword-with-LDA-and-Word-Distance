...
#print(dictionary)
dictionary_path = "/home/ice-kms/LDAModel/TopicNum50_LDADic_fin.dict.dict"
...
ldamodel = gensim.models.ldamodel.LdaModel(corpus,num_topics=50,id2word = dictionary, passes = 200, iterations=2000)

#print(len(ldamodel))

print(ldamodel.show_topics(num_topics=50,num_words=5,formatted=False))

lda_model_path = "/home/ice-kms/LDAModel/TopicNum50_LDAModel_fin.lda"
