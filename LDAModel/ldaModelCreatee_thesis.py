...
sql = "(select * from thesis where code = 1 limit 6,24) union (select * from thesis where code = 2 limit 6,24) union (select * from thesis where code = 3 limit 6,24) union (select * from thesis where code = 4 limit 6,24) union (select * from thesis where code = 5 limit 6,24) union (select * from thesis where code = 6 limit 6,24) union (select * from thesis where code = 7 limit 6,24) union (select * from thesis where code = 8 limit 6,24) union (select * from thesis where code = 9 limit 6,24) union (select * from thesis where code = 10 limit 6,24)"
...
#print(dictionary)
dictionary_path = "/home/ice-kms/LDAModel/Thesis16_LDADic.dict"
...
print(ldamodel.show_topics(num_topics=20,num_words=50,formatted=False))

lda_model_path = "/home/ice-kms/LDAModel/Thesis16_LDA.lda"
