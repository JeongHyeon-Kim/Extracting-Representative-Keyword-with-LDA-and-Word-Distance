...
dictionary_path = "/home/ice-kms/LDAModel/Real_articleDic_10000_compound_topicNum_200.dict"
...
ldamodel = gensim.models.ldamodel.LdaModel(corpus,num_topics=200,id2word = dictionary, passes = 100)

#print(len(ldamodel))

print(ldamodel.show_topics(num_topics=100,num_words=5,formatted=False))

lda_model_path = "/home/ice-kms/LDAModel/Real_lda_10000_pass_100_topicNum_200.lda"
