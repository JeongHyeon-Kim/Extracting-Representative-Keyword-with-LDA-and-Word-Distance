...
cursor.execute("set names utf8")
sql = "select distinct(Content) from Text2 where ArticleNumber <= 10011"
...
dictionary_path = "/home/ice-kms/LDAModel/iter_1000_Real_articleDic_10000_compound_topicNum_15.dict"
...
ldamodel = gensim.models.ldamodel.LdaModel(corpus, num_topics=15, id2word = dictionary, passes = 100, iterations=1000)

#print(len(ldamodel))

print(ldamodel.show_topics(num_topics=15,num_words=5,formatted=False))

lda_model_path = "/home/ice-kms/LDAModel/iter_1000_Real_lda_10000_pass_100_topicNum_15.lda"
