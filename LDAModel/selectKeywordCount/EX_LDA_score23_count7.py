...
for exnum in range(0,10):
	sql = "SELECT * FROM ( select * from Test4 limit 500) as A where A.Articlenumber not in (select ArticleNumber from CombineTagging group by ArticleNumber having count(*) = 5 or count(*) = 6)"
