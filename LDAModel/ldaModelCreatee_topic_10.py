...
ldamodel = gensim.models.ldamodel.LdaModel(corpus,num_topics=10, id2word = dictionary, passes = 100, iterations=1000)

#print(len(ldamodel))

print(ldamodel.show_topics(num_topics=10,num_words=5,formatted=False))
